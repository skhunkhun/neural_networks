...
def nnOne(plt):
    ...
    # Define the neural network class of one
        ...
        def train(self, X, y, learning_rate=0.1, epochs=20, batch_size=32):
            ...
            for epoch in range(epochs):
                ...
                for i in range(0, X_train.shape[0], batch_size):
                    ...
                    # Forward pass
                    y_prediction, A1 = self.forward(X_batch)
                    ...
                    # Backward pass
                    dW1, db1, dW2, db2 = self.backward(X_batch, y_batch, y_prediction, A1)
                ...
                y_valid_prediction, _ = self.forward(X_val)
